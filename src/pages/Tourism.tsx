        ...
        >
          ...
          <div className="relative z-10 max-w-384 mx-auto sm:px-6 px-4">
            ...
            <Text className="text-primary-100 md:text-xl text-base max-w-xl mb-6">
              Discover Olongapo City, a historic coastal gateway along Subic Bay
              where natural harbor views, resort-lined beaches, and vibrant
              urban life come together in one dynamic destination.
            </Text>
          </div>
        </section>
