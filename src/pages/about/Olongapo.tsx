...
import { aboutOlongapoData } from '../../data/yamlLoader';
import PageBanner from '../../components/ui/PageBanner';
import { MapPin } from 'lucide-react';

const data = aboutOlongapoData;

const AboutOlongapo: React.FC = () => {
  return (
    <>
      <SEO
      ...
      <PageBanner
        ...
        description="Olongapo is a vibrant, highly urbanized coastal city in Zambales, Philippines, 
  renowned as a former U.S. Naval base turned tourism, industrial, and commercial hub."
        titleSize="6xl"
      />
      ...
      <Section className="mb-12 sm:px-10 lg:px-20 xl:px-30">
        ...
        <div className="mb-5">
          <div
            ...
            role="region"
            aria-label="Key statistics about Olongapo"
          >
            {data.stats.map(stat => {
              ...
              <div className="flex flex-col lg:flex-row">
                ...
                <div className="relative flex items-stretch p-4 lg:p-6 lg:w-1/2">
                  <div className="relative w-full overflow-hidden bg-white border shadow-inner rounded-xl border-primary-200/50">
                    <iframe
                      title="Map showing location of Olongapo City, Zambales in the Philippines"
                      src="https://maps.google.com/maps?q=14.8292,120.2828&z=14&output=embed"
                      className="w-full h-80 lg:h-full min-h-75"
                      loading="lazy"
                      aria-label="Geographic map of Olongapo City, Zambales"
                    />
                  </div>
                </div>
              </div>
