...
export default function WeatherMapSection() {
  ...
  useEffect(() => {
    ...
    fetch(
      'https://api.open-meteo.com/v1/forecast?latitude=14.8386&longitude=120.2842&current_weather=true&timezone=Asia%2FManila'
    )
      .then(r => r.json())
      .then(data => {
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {/* OpenStreetMap — centered on Malolos, Bulacan */}
          <div className="rounded-2xl overflow-hidden border border-gray-200 shadow-sm min-h-[220px]">
            <iframe
              title={t('weatherMap.mapTitle')}
              src="https://www.openstreetmap.org/export/embed.html?bbox=120.20%2C14.78%2C120.37%2C14.90&layer=mapnik&marker=14.8386%2C120.2842"
